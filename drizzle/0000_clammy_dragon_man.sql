CREATE TYPE "public"."currency" AS ENUM('PYUSD', 'USDT', 'BTC', 'ETH', 'USD');--> statement-breakpoint
...
CREATE TYPE "public"."payment_method" AS ENUM('pyusd', 'usdt_trc20', 'usdt_erc20', 'bitcoin', 'ethereum', 'yellow_swap');--> statement-breakpoint
...
CREATE TYPE "public"."transaction_type" AS ENUM('payment', 'payout', 'refund', 'commission', 'swap');--> statement-breakpoint
...
CREATE TABLE "payments" (
	...
	"web3_transaction_hash" text,
	"pyusd_amount" numeric(18, 0),
	"yellow_swap_hash" text,
	"original_token" text,
	"original_amount" numeric(18, 0),
	"gas_used" numeric(10, 0),
...
CREATE TABLE "users" (
	...
	"is_web3_enabled" boolean DEFAULT false,
