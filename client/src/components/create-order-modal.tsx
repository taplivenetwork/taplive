...
export function CreateOrderModal({ open, onOpenChange, selectedLocation }: CreateOrderModalProps) {
  ...
  const geocodeAddress = async (address: string) => {
    ...
    const geocodingProviders = [
      ...
      {
        name: 'LocationIQ',
        url: `https://us1.locationiq.com/v1/search.php?key=pk.0f147952a41c209c5446b00b0c7587e9&q=${encodeURIComponent(
          address
        )}&format=json&limit=1`,
        parseResponse: (data: any[]) =>
          data.length > 0
      ...
      try {
        ...
        if (result) {
          ...
          toast({
            ...
            description: `${result.display_name.split(',').slice(0, 3).join(', ')} (via ${
              provider.name
            })`,
          })
    ...
    toast({
      ...
      description:
        'Could not find the specified address using any available service. Please try a different location.',
      variant: 'destructive',
    })
                    ...
                    <FormItem>
                      ...
                      <Select onValueChange={(value) => field.onChange(parseInt(value))}>
                        ...
                        <SelectContent className='z-[10000]'>
                          <SelectItem value='30'>
                            <TranslatedText>30 minutes</TranslatedText>
                          </SelectItem>
                          <SelectItem value='60'>
                            <TranslatedText>1 hour</TranslatedText>
                          </SelectItem>
                          <SelectItem value='120'>
                            <TranslatedText>2 hours</TranslatedText>
                          </SelectItem>
                          <SelectItem value='180'>
                            <TranslatedText>3 hours</TranslatedText>
                          </SelectItem>
                        </SelectContent>
                      </Select>
                      <FormMessage />
                    ...
                    <Select onValueChange={field.onChange}>
                      ...
                      <SelectContent className='z-[10000]'>
                        <SelectItem value='music'>
                          <TranslatedText>Music & Entertainment</TranslatedText>
                        </SelectItem>
                        <SelectItem value='food'>
                          <TranslatedText>Food & Dining</TranslatedText>
                        </SelectItem>
                        <SelectItem value='travel'>
                          <TranslatedText>Travel & Tourism</TranslatedText>
                        </SelectItem>
                        <SelectItem value='events'>
                          <TranslatedText>Events & Gatherings</TranslatedText>
                        </SelectItem>
                        <SelectItem value='education'>
                          <TranslatedText>Educational</TranslatedText>
                        </SelectItem>
                        <SelectItem value='fitness'>
                          <TranslatedText>Fitness & Wellness</TranslatedText>
                        </SelectItem>
                      </SelectContent>
                    </Select>
                    <FormMessage />
                        ...
                        >
                          <div className='flex items-center space-x-3'>
                            ...
                            <Label htmlFor='solo' className='flex-1'>
                              <div className='font-medium text-foreground'>
                                <TranslatedText>Solo Payment</TranslatedText>
                              </div>
                              <div className='text-sm text-muted-foreground'>
                                <TranslatedText>Pay the full amount yourself</TranslatedText>
                              </div>
                            </Label>
                          </div>
                          ...
                          <div className='flex items-center space-x-3'>
                            ...
                            <Label htmlFor='group' className='flex-1'>
                              <div className='font-medium text-foreground'>
                                <TranslatedText>Group Payment</TranslatedText>
                              </div>
                              <div className='text-sm text-muted-foreground'>
                                <TranslatedText>Split the cost with others</TranslatedText>
                              </div>
                            </Label>
                          </div>
                        </RadioGroup>
                ...
                <div className='grid grid-cols-2 gap-4'>
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          <TranslatedText>Total Budget</TranslatedText>
                        </FormLabel>
                        <FormControl>
                  ...
                  {paymentType === 'group' && (
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>
                            <TranslatedText>Max Participants</TranslatedText>
                          </FormLabel>
                          <FormControl>
                            <Input
                              type='number'
