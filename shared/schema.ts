...
export const insertOrderSchema = z.object({
  ...
  price: z.number(),
  currency: z.enum(['USD', 'USDT', 'BTC', 'ETH']).default('USD'),
  ...
  isPayoutProcessed: z.boolean().optional().nullable(),
  groupType: z.enum(['single', 'aa_split', 'group_booking']).optional().nullable(),
  groupId: z.string().optional().nullable(),
  splitAmount: z.number().optional().nullable(),
  minParticipants: z.number().optional().nullable(),
  riskLevel: z.enum(['safe', 'low', 'medium', 'high', 'extreme', 'forbidden']).optional().nullable(),
  weatherAlert: z.enum(['clear', 'watch', 'warning', 'emergency']).optional().nullable(),
  geoFenceStatus: z.string().optional().nullable(),
  isHighRiskArea: z.boolean().optional().nullable(),
  isMilitaryZone: z.boolean().optional().nullable(),
  weatherConditions: z.string().optional().nullable(),
  contentFlags: z.array(z.string()).optional().nullable(),
  keywordViolations: z.array(z.string()).optional().nullable(),
  voiceAlerts: z.number().optional().nullable(),
  recordingUrl: z.string().optional().nullable(),
  replayAvailable: z.boolean().optional().nullable(),
  recordingDuration: z.number().optional().nullable(),
});
