...
export const insertOrderSchema = z.object({
  ...
  platformFee: z.number().or(z.string().transform(val => parseFloat(val))).optional(),
  providerEarnings: z.number().or(z.string().transform(val => parseFloat(val))).optional(),
  ...
  isPayoutProcessed: z.boolean().optional(),
  groupType: z.enum(['single', 'aa_split', 'group_booking']).optional(),
  groupId: z.string().optional(),
  splitAmount: z.number().or(z.string().transform(val => parseFloat(val))).optional(),
  minParticipants: z.number().optional(),
  riskLevel: z.enum(['safe', 'low', 'medium', 'high', 'extreme', 'forbidden']).optional(),
  weatherAlert: z.enum(['clear', 'watch', 'warning', 'emergency']).optional(),
  geoFenceStatus: z.string().optional(),
  isHighRiskArea: z.boolean().optional(),
  isMilitaryZone: z.boolean().optional(),
  weatherConditions: z.string().optional(),
  contentFlags: z.array(z.string()).optional(),
  keywordViolations: z.array(z.string()).optional(),
  voiceAlerts: z.number().optional(),
